 ...
 * DB Queries
 */
class HStreamTweetsQueries {
	constructor(params) {
		this.cryptr = params.cryptr;
		this.dataDir = params.dataDir;
		this.utils = params.utils;
		this.path = params.path;
		this.DBNAME = constants.DATABASE_NAMES.HISTORIC_STREAMTWEETS;

		const { HStreamTweetsDBAdapter } = require("../adapters/hstreamtweets");
		this.db = new HStreamTweetsDBAdapter({ cryptr: this.cryptr, dataDir: this.dataDir, path: this.path }).get();
	}
...
exports.HStreamTweetsQueries = HStreamTweetsQueries;