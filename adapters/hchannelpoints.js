...
class HChannelPointsDBAdapter {
	...
	constructor(params) {
		...
		this.dataFile = this.path.join(this.dataDir, constants.DATABASE_NAMES.HISTORIC_CHANNELPOINTS + constants.DATA_FILE_HISTORIC_EXT);
	}
...
exports.HChannelPointsDBAdapter = HChannelPointsDBAdapter;