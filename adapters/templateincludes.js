...
const { templateincludes } = require("../defaults/templateincludes");

/**
 * DB Adapter
 */
class TemplateIncludesDBAdapter {
	/**
	 *
	...
	constructor(params) {
		...
		this.dataFile = this.path.join(this.dataDir, constants.SETTINGS_DATABASE_NAMES.TEMPLATE_INCLUDES + constants.DATA_FILE_SETTINGS);
	}
...
exports.TemplateIncludesDBAdapter = TemplateIncludesDBAdapter;