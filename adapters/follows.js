...
class FollowsDBAdapter {
	...
	constructor(params) {
		...
		this.dataFile = this.path.join(this.dataDir, constants.DATABASE_NAMES.FOLLOWS + constants.DATA_FILE_EXT);
	}

	getDefaults() {
		let obj = {};
		obj[constants.DATABASE_NAMES.FOLLOWS] = [];
...
exports.FollowsDBAdapter = FollowsDBAdapter;