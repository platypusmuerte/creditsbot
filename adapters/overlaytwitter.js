...
class OverlayTwitterDBAdapter {
	...
	constructor(params) {
		...
		this.dataFile = this.path.join(this.dataDir, constants.SETTINGS_DATABASE_NAMES.OVERLAY_TWITTER + constants.DATA_FILE_SETTINGS);
	}
...
exports.OverlayTwitterDBAdapter = OverlayTwitterDBAdapter;