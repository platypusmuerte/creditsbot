...
class HRaidsDBAdapter {
	...
	constructor(params) {
		...
		this.dataFile = this.path.join(this.dataDir, constants.DATABASE_NAMES.HISTORIC_RAIDS + constants.DATA_FILE_HISTORIC_EXT);
	}
...
exports.HRaidsDBAdapter = HRaidsDBAdapter;