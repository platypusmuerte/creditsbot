...
class GiftSubsDBAdapter {
	...
	constructor(params) {
		...
		this.dataFile = this.path.join(this.dataDir, constants.DATABASE_NAMES.GIFTSUBS + constants.DATA_FILE_EXT);
	}
...
exports.GiftSubsDBAdapter = GiftSubsDBAdapter;