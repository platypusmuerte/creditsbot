...
class HHostsDBAdapter {
	...
	constructor(params) {
		...
		this.dataFile = this.path.join(this.dataDir, constants.DATABASE_NAMES.HISTORIC_HOSTS + constants.DATA_FILE_HISTORIC_EXT);
	}
...
exports.HHostsDBAdapter = HHostsDBAdapter;