...
class HBitsDBAdapter {
	...
	constructor(params) {
		...
		this.dataFile = this.path.join(this.dataDir, constants.DATABASE_NAMES.HISTORIC_BITS + constants.DATA_FILE_HISTORIC_EXT);
	}
...
exports.HBitsDBAdapter = HBitsDBAdapter;