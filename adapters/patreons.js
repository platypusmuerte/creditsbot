...
class PatreonsDBAdapter {
	...
	constructor(params) {
		...
		this.dataFile = this.path.join(this.dataDir, constants.DATABASE_NAMES.PATREONS + constants.DATA_FILE_EXT);
	}

	getDefaults() {
		let obj = {};
		obj[constants.DATABASE_NAMES.PATREONS] = [];
...
exports.PatreonsDBAdapter = PatreonsDBAdapter;