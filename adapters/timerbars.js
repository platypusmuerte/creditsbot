...
class TimerBarsDBAdapter {
	...
	constructor(params) {
		...
		this.dataFile = this.path.join(this.dataDir, constants.SETTINGS_DATABASE_NAMES.TIMERBARS + constants.DATA_FILE_SETTINGS);
	}
...
exports.TimerBarsDBAdapter = TimerBarsDBAdapter;