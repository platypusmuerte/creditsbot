...
class HSubsDBAdapter {
	...
	constructor(params) {
		...
		this.dataFile = this.path.join(this.dataDir, constants.DATABASE_NAMES.HISTORIC_SUBS + constants.DATA_FILE_HISTORIC_EXT);
	}
...
exports.HSubsDBAdapter = HSubsDBAdapter;