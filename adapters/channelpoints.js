...
class ChannelPointsDBAdapter {
	...
	constructor(params) {
		...
		this.dataFile = this.path.join(this.dataDir, constants.DATABASE_NAMES.CHANNELPOINTS + constants.DATA_FILE_EXT);
	}
...
exports.ChannelPointsDBAdapter = ChannelPointsDBAdapter;