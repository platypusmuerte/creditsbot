 ...
 * DB Adapter
 */
class TimerBarsCustCSSDBAdapter {
	/**
	 *
	...
	constructor(params) {
		...
		this.dataFile = this.path.join(this.dataDir, constants.SETTINGS_DATABASE_NAMES.TIMERBARSCUSTCSS + constants.DATA_FILE_SETTINGS);
	}
...
exports.TimerBarsCustCSSDBAdapter = TimerBarsCustCSSDBAdapter;