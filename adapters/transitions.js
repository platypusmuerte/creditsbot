...
class TransitionsDBAdapter {
	...
	constructor(params) {
		...
		this.dataFile = this.path.join(this.dataDir, constants.SETTINGS_DATABASE_NAMES.TRANSITIONS + constants.DATA_FILE_SETTINGS);
	}
...
exports.TransitionsDBAdapter = TransitionsDBAdapter;