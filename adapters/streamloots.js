...
class StreamLootsDBAdapter {
	...
	constructor(params) {
		...
		this.dataFile = this.path.join(this.dataDir, constants.DATABASE_NAMES.STREAMLOOTS + constants.DATA_FILE_EXT);
	}

	getDefaults() {
		let obj = {};
		obj[constants.DATABASE_NAMES.STREAMLOOTS] = [];
...
exports.StreamLootsDBAdapter = StreamLootsDBAdapter;