...
class HGiftSubsDBAdapter {
	...
	constructor(params) {
		...
		this.dataFile = this.path.join(this.dataDir, constants.DATABASE_NAMES.HISTORIC_GIFTSUBS + constants.DATA_FILE_HISTORIC_EXT);
	}

	getDefaults() {
		let obj = {};
		obj[constants.DATABASE_NAMES.HISTORIC_GIFTSUBS] = [];
...
exports.HGiftSubsDBAdapter = HGiftSubsDBAdapter;