...
class ModsDBAdapter {
	...
	constructor(params) {
		...
		this.dataFile = this.path.join(this.dataDir, constants.DATABASE_NAMES.MODS + constants.DATA_FILE_EXT);
	}

	getDefaults() {
		let obj = {};
		obj[constants.DATABASE_NAMES.MODS] = [];
...
exports.ModsDBAdapter = ModsDBAdapter;